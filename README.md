...
<p align="center">
<img src="https://readme-typing-svg.herokuapp.com?font=Poppins&size=23&duration=3500&pause=1000&center=true&vCenter=true&width=750&lines=Computer+Engineering+Student;Computer+Vision+Enthusiast;Embedded+Systems+Developer;Python+Developer;Data+Analytics+Learner" />
</p>
...
graph TD
    %% Root Node
    Root(Engineering) --> DA[Data Analytics]
    Root --> CV[Computer Vision]
    Root --> ES[Embedded Systems]

    %% Data Analytics Sub-nodes
    DA --> P1(Python)
    DA --> P2(Pandas)
    DA --> P3(NumPy)
    DA --> P4(Matplotlib)
    ...
    %% Styling
    style Root fill:#9c0511,stroke:#333,stroke-width:4px
    style DA fill:#024a17,stroke:#01579b
    style CV fill:#020966,stroke:#e65100
    style ES fill:#334502,stroke:#1b5e20
```
---
...
<img src="https://github-readme-streak-stats.herokuapp.com/?user=Im-Saad08&theme=tokyonight"/>
...
<a href="mailto:imsaad.work@gmail.com">
